...
function AdminLogin({ onAuthenticated, demoLogin }) {
  ...
  async function submit(event) {
    ...
    catch (err) { setError(err && err.name === "AbortError" ? "Request timed out — the backend may be waking from a cold start. Please try again." : "Network or CSP error connecting to the authentication service."); } finally { setLoading(false); }
  }
